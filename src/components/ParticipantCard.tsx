...
function ParticipantCard({
  ...
  return (
    <li className="relative">
      <div
        className={`flex h-40 w-full flex-col rounded-3xl pb-6 pl-5 pr-4 pt-4 ${participantRole === 'HOST' ? 'bg-blue-B70' : 'border-[1.5px] border-solid border-white/30 bg-white/20'}`}
      >
